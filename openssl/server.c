...
SSL_CTX* InitServerCTX(void)  // ctx is an context(environment for ssl connection) nothing is registered to CTX in this function
{
    SSL_METHOD *method;
    SSL_CTX *ctx;
...
void ShowCerts(SSL* ssl) //print certificate
{ 
    X509 *cert;
    char *line;
...
//Only root user have the permsion to run the server
    ...
    LoadCertificates(ctx, "mycert.pem", "mycert.pem"); /* load certs into ctx*/
